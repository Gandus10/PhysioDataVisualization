...
public class MeasuresAdapter extends BaseAdapter implements Filterable{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
           ...
           holder.stressTextView = (TextView) convertView.findViewById(R.id.heartBeatTextView);
        ...
        holder.stressTextView.setText(" Stress : " + String.valueOf(measures.getStressIndex()));
